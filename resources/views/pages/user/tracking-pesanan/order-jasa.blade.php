                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="mt-2 text-secondary">Pada halaman ini Anda dapat mencari dan melihat Order Jasa
                                dan Status Tracking Jasa Pesanan Anda.
                            </p>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <div class="modal fade" id="modalTracking" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Tracking Layanan
                                                                Jasa
                                                                <b>"BWX-1019"</b>
                                                            </h5>
                                                            <button type="button" class="close" data-dismiss="modal"
