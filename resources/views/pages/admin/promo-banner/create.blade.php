...
@section('title')
    <title>Tambah Promo Banner | Print-Shop</title>
@endsection
            ...
            <div class="row justify-content-start">
                <div class="col-sm-12">
                    <div class="alert  alert-success alert-dismissible fade show" role="alert">
                        ...
                        di Halaman Tambah Promo Banner
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Form Tambah Data Promo Banner</strong>
                            <p class="mt-2 text-secondary">Silahkan isi field sesuai dengan data Promo Banner yang ingin
                                Anda
                                tambahkan.</p>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ $action }}" class="forms-sample" method="POST"
                                        ...
                                        <a href="{{ route('promo.banner.index') }}"
