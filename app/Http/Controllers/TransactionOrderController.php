...
class TransactionOrderController extends Controller
{
    ...
    public function update_tracking_product(Request $request, $transaction_order_id)
    {
        // mengambil data transaction order
        $data = TransactionOrder::findOrFail($transaction_order_id);
    ...
    public function update_tracking_service(Request $request, $transaction_order_id)
    {
        // mengambil data transaction order
        $data = TransactionOrder::findOrFail($transaction_order_id);
    ...
    public function clearing_transaction_product($transaction_order_id)
    {
        // updatte transaksi order
        TransactionOrder::where('id', $transaction_order_id)->update([
    ...
    public function clearing_order_service($transaction_order_id)
    {
        // updatte transaksi order
        TransactionOrder::where('id', $transaction_order_id)->update([
            'status_delivery' => 'Order Done',
